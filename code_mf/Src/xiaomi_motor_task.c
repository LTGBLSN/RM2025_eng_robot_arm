...
{
    xiaomimotors[4].given_speed = -0.002f * (float )rc_ch3 ;
    xiaomimotors[4].give_tor = xiaomi_can2_id1_speed_pid_loop(xiaomimotors[4].given_speed);
    xiaomimotors[5].given_speed = 0.002f * (float )rc_ch1 ;
    xiaomimotors[5].give_tor = xiaomi_can2_id2_speed_pid_loop(xiaomimotors[5].given_speed);
}
...
{
    PID_calc(&xiaomi_can2_ID1_speed_pid, xiaomimotors[4].fifilter_compute_speed , xiaomi_can2_id1_speed_set_loop);
...
{
    PID_calc(&xiaomi_can2_ID2_speed_pid, xiaomimotors[5].fifilter_compute_speed , xiaomi_can2_id2_speed_set_loop);
